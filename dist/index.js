...
const resolveFetch = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(() => __importStar(__nccwpck_require__(9805)))).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
const errors_1 = __nccwpck_require__(6723);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const GoTrueAdminApi_1 = __importDefault(__nccwpck_require__(4599));
const constants_1 = __nccwpck_require__(8907);
const errors_1 = __nccwpck_require__(6723);
const fetch_1 = __nccwpck_require__(202);
const helpers_1 = __nccwpck_require__(2846);
const local_storage_1 = __importDefault(__nccwpck_require__(9766));
...
__exportStar(__nccwpck_require__(6723), exports);
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PostgrestQueryBuilder_1 = __importDefault(__nccwpck_require__(5683));
const PostgrestFilterBuilder_1 = __importDefault(__nccwpck_require__(1446));
const constants_1 = __nccwpck_require__(879);
/**
 * PostgREST client.
 *
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PostgrestTransformBuilder_1 = __importDefault(__nccwpck_require__(39));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PostgrestBuilder_1 = __importDefault(__nccwpck_require__(9963));
...
const version_1 = __nccwpck_require__(3481);
...
var PostgrestClient_1 = __nccwpck_require__(8223);
...
var PostgrestQueryBuilder_1 = __nccwpck_require__(5683);
...
var PostgrestFilterBuilder_1 = __nccwpck_require__(1446);
...
var PostgrestTransformBuilder_1 = __nccwpck_require__(39);
...
var PostgrestBuilder_1 = __nccwpck_require__(9963);
...
const RealtimePresence_1 = __importDefault(__nccwpck_require__(5583));
...
const RealtimeChannel_1 = __importDefault(__nccwpck_require__(9911));
const noop = () => { };
...
const RealtimeChannel_1 = __importStar(__nccwpck_require__(9911));
...
const RealtimePresence_1 = __importStar(__nccwpck_require__(5583));
...
const StorageFileApi_1 = __importDefault(__nccwpck_require__(710));
const StorageBucketApi_1 = __importDefault(__nccwpck_require__(3528));
...
__exportStar(__nccwpck_require__(2758), exports);
//# sourceMappingURL=index.js.map
...
const resolveResponse = () => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof Response === 'undefined') {
        return (yield Promise.resolve().then(() => __importStar(__nccwpck_require__(9805)))).Response;
    }
    return Response;
});
...
var isEmpty = __nccwpck_require__(3912);
var isEmpty_default = /*#__PURE__*/__nccwpck_require__.n(isEmpty);
...
async function getMostRecentReleaseCandidateNumber(supabaseClient, tableName, {
  ...
  if (!isUndefined_default()(name) && !isEmpty_default()(name)) query = query.eq('name', name)
  if (!isUndefined_default()(version) && !isEmpty_default()(version)) query = query.eq('version', version)
  if (!isUndefined_default()(region) && !isEmpty_default()(region)) query = query.eq('region', region)
  if (!isUndefined_default()(namespace) && !isEmpty_default()(namespace)) query = query.eq('namespace', namespace)
